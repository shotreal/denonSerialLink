...
void setup() {
  ...
  if (!LittleFS.begin()) {
    ...
    html += "<table>";
    html += "<tr><td><button class='btn' onclick='sendRequest(\"/tune?freq=9720\")'>SWR3 Stuttgart</button></td>";
    html += "<td><button class='btn' onclick='sendRequest(\"/tune?freq=10770\")'>Hitradio antenne 1</button></td>";
    html += "<td><button class='btn' onclick='sendRequest(\"/tune?freq=09150\")'>SWR1 Baden-Württemberg</button></td></tr>";
    html += "<tr><td><button class='btn' onclick='sendRequest(\"/tune?freq=10730\")'>SWR4 Stuttgart</button></td>";
    html += "<td><button class='btn' onclick='sendRequest(\"/tune?freq=08950\")'>bigFM Stuttgart</button></td>";
    html += "<td><button class='btn' onclick='sendRequest(\"/tune?freq=10630\")'>Deutschlandfunk</button></td></tr>";
    html += "<tr><td><button class='btn' onclick='sendRequest(\"/tune?freq=10070\")'>Radio Energy Stuttgart</button></td>";
    html += "<td><button class='btn' onclick='sendRequest(\"/tune?freq=09180\")'>Dasding</button></td>";
    html += "<td><button class='btn' onclick='sendRequest(\"/tune?freq=10210\")'>Sunshine Live</button></td></tr>";
    html += "<tr><td><button class='btn' onclick='sendRequest(\"/tune?freq=10770\")'>Die neue 107.7</button></td>";
    html += "<td><button class='btn' onclick='sendRequest(\"/tune?freq=08910\")'>Deutschlandfunk Kultur</button></td>";
    html += "<td><button class='btn' onclick='sendRequest(\"/tune?freq=08800\")'>SWR2 Baden-Württemberg</button></td></tr>";
    html += "<tr><td><button class='btn' onclick='sendRequest(\"/tune?freq=09000\")'>SWR Aktuell</button></td>";
    html += "<td><button class='btn' onclick='sendRequest(\"/tune?freq=10110\")'>Radio Regenbogen</button></td>";
    html += "<td><button class='btn' onclick='sendRequest(\"/tune?freq=10610\")'>Klassik Radio</button></td></tr>";
    html += "<tr><td><button class='btn' onclick='sendRequest(\"/tune?freq=10750\")'>Radio TON Stuttgart</button></td>";
    html += "<td><button class='btn' onclick='sendRequest(\"/tune?freq=09680\")'>egoFM</button></td>";
    html += "<td><button class='btn' onclick='sendRequest(\"/tune?freq=10130\")'>antenne 1 Relax</button></td></tr>";
    html += "<tr><td><button class='btn' onclick='sendRequest(\"/tune?freq=10210\")'>Regenbogen Zwei</button></td>";
    html += "<td><button class='btn' onclick='sendRequest(\"/tune?freq=09300\")'>Schwarzwaldradio</button></td>";
    html += "<td><button class='btn' onclick='sendRequest(\"/tune?freq=10010\")'>Radio Seefunk</button></td></tr>";
    html += "<tr><td><button class='btn' onclick='sendRequest(\"/tune?freq=09920\")'>Freies Radio für Stuttgart</button></td></tr>";
    html += "</table>";
